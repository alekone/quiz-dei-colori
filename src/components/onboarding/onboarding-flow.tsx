...
export default function OnboardingFlow() {
  ...
  const detourTitles = useMemo(
    () => [
      ...
      "Errore 404: buona volontà non trovata",
      "Hai appena sbagliato il tutorial. IL TUTORIAL.",
      "Guarda, anche il pappagallo del Grog ha detto sì",
      "NO è una parola di quattro lettere. Pensaci.",
      "Il tasto SI era lì, innocente, ad aspettarti",
      "Stai leggendo le istruzioni al contrario?",
      "Questo non era un trabocchetto. Adesso lo è.",
      "Scelta interessante. Sbagliata, ma interessante.",
      "Hai premuto NO. Il destino prende nota.",
      "Benvenuto nel percorso difficile. Non esiste.",
      "Somewhere, a pirate cries.",
      "Il cursore voleva andare a destra. Tu no.",
      "Tecnicamente hai cliccato. Tecnicamente.",
      "Questo si chiama auto-sabotaggio, amico mio",
      "Stai testando i limiti del sistema. Il sistema regge.",
      "La tua avventura inizia nel modo peggiore possibile",
      "Hai bisogno di un walkthrough per fare onboarding?",
      "Risposta registrata. Tristezza aggiornata di conseguenza.",
    ],
    [],
  );
